...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Onde Assistir a Copa" },
      {
        name: "description",
        content: "Veja onde assistir aos jogos da Copa: TV, streaming, horário e estádio.",
      },
      { name: "theme-color", content: "#0b1220" },
      { property: "og:title", content: "Onde Assistir a Copa" },
      {
      ...
      { name: "apple-mobile-web-app-title", content: "Copa" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:title", content: "Onde Assistir a Copa" },
